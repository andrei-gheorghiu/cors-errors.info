In Chrome or Firefox you should be able to see the preflight `OPTIONS` request in the _Network_ tab of the developer tools. Right-clicking on the request should present an option to `Copy as cURL`.
